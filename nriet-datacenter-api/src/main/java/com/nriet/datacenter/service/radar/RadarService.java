package com.nriet.datacenter.service.radar;
...
public interface RadarService {
	 ...
	 * @return
	 */
	Map<String, List<JGRadar>> readRadarData(Calendar time, String stationId);
	 ...
	 * @return
	 */
	List<JGRadarShear> getJGRadarShear(String time);
