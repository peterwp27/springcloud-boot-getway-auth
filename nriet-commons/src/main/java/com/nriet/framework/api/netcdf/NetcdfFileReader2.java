...
import com.nriet.framework.core.ThreadPoolUtil;
...
public class NetcdfFileReader2 {

	private final static Logger logger = LoggerFactory.getLogger(NetcdfFileReader2.class);

	public static List<NcData> readNcFiles2(String path) throws InterruptedException, ExecutionException {
		ExecutorService es = ThreadPoolUtil.getExecutorService();
		NcData nc = new NcData();
		List<NcData> rslist = new LinkedList();
		...
		return (List<NcData>)(future1.get());
	}
...
//		List<List<NcData>> rslist = new LinkedList<List<NcData>>();
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		for (int i = 0; i < 10; i++) {
			String path = "path" + i;
//			List<NcData> list = readNcFiles(path);
